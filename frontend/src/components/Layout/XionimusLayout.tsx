        ...
        <HStack spacing={3} justify={sidebarCollapsed ? 'center' : 'flex-start'}>
          ...
          {!sidebarCollapsed && (
            <VStack align="start" spacing={0}>
              ...
              <Text 
                fontSize="xs" 
                color={useColorModeValue('gray.600', 'rgba(0, 212, 255, 0.7)')}
                fontFamily="'Inter', sans-serif"
                letterSpacing="0.5px"
        ...
        {!sidebarCollapsed && (
          <HStack spacing={2} mt={3} justify="center">
            <Box
              ...
              h="8px"
              borderRadius="50%"
              bg={useColorModeValue('#0088cc', '#0088cc')}
              boxShadow={useColorModeValue('0 0 8px #0088cc', '0 0 12px #0088cc, 0 0 20px rgba(0, 212, 255, 0.5)')}
            />
