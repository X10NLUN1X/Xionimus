              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-amber-100 font-medium text-sm">
                    Sources ({filteredCitations.length} / {result.citations.length})
                  </span>
                </div>
                <svg
                  className={`w-4 h-4 text-amber-400 transition-transform duration-200 ${
                    ...
                    {filteredCitations.map((citation, index) => {
                      ...
                      return (
                        <a
                          ...
                          className="flex items-center gap-3 p-3 rounded-lg bg-black/30 hover:bg-amber-500/10 transition-all duration-150 border border-amber-500/10 hover:border-amber-500/30 group"
                        >
                          <span className="text-2xl">{icon}</span>
                          <div className="flex-1 min-w-0">
                            <div className="text-sm text-amber-100 truncate font-medium">
                              {domain}
                            </div>
                            <div className="flex items-center gap-2 mt-1">
                              <span className="text-xs text-amber-200/50">
                                Source {result.citations.indexOf(citation) + 1}
                              </span>
                              <span className="text-amber-500/30">•</span>
                              <span className="text-xs text-amber-300/50 px-2 py-0.5 bg-amber-500/10 rounded">
                                {category}
                              </span>
                            </div>
                          </div>
                          <svg
                            className="w-4 h-4 text-amber-400/50 group-hover:text-amber-400 transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
