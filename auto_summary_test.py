...
class AutoSummaryTester:
    ...
    def test_code_generation_with_auto_summary(self) -> Dict[str, Any]:
        """Test code generation request that should trigger auto-summary"""
        logger.info("🚀 Testing code generation with auto-summary")
        ...
        try:
            ...
            logger.info("📤 Sending code generation request...")
...
def main():
    """Main test runner for Auto-Summary Functionality Testing"""
    logger.info("🔄 Starting Auto-Summary Functionality Testing Suite")
    logger.info("=" * 80)
    
    tester = AutoSummaryTester()
    ...
    # Test 3: Code Generation with Auto-Summary
    logger.info("\n3️⃣ Testing Code Generation with Auto-Summary")
    code_gen_result = tester.test_code_generation_with_auto_summary()
    ...
    if code_gen_result['status'] == 'success':
        ...
        # Test 4: Verify Code Detection
        logger.info("\n4️⃣ Testing Code Detection in Response")
        ...
        # Test 5: Verify Auto-Summary Format
        logger.info("\n5️⃣ Testing Auto-Summary Format Verification")
    ...
    logger.info("\n6️⃣ Checking Backend Logs for Auto-Summary")
    ...
    # Summary
    logger.info("\n" + "=" * 80)
    logger.info("🔄 AUTO-SUMMARY TEST SUMMARY")
    logger.info("=" * 80)
