...
class AIManager:
    ...
    def get_available_models(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "anthropic": [
                "claude-3-5-haiku-20241022",      # ⭐ 73% GÜNSTIGER - $2.40/1M Tokens - Schnell & günstig (Junior Mode)
                "claude-sonnet-4-5-20250929",     # ✅ DEFAULT - Premium Modell - $9.00/1M Tokens (Senior Mode)
                "claude-opus-4-1"                 # 🚀 ULTIMATE - Most capable - $15.00/1M Tokens - For complex tasks (Senior Mode)
            ],
            "perplexity": [
